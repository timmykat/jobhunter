...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { company: @opportunity.company, on_site_interview: @opportunity.on_site_interview, phone_interview: @opportunity.phone_interview, position: @opportunity.position, state_id: @opportunity.state_id }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { company: @opportunity.company, on_site_interview: @opportunity.on_site_interview, phone_interview: @opportunity.phone_interview, position: @opportunity.position, state_id: @opportunity.state_id }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
